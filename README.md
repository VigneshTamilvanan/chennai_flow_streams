...
> **AI-powered home-buying guide for Indian cities** — compare flood risk, commute times, property prices and liveability across neighbourhoods, all on one interactive map.
...
- **Know the real flood risk** — built on ALOS PALSAR 12.5 m satellite DEM data and historical flood events, not just anecdotal reports
...
| 📍 **Drop-a-Pin** | Click anywhere on the map for an instant area flood & liveability report |
| 🌊 **Flood Layers** | Stream network overlay from ALOS PALSAR DEM analysis |
...
| Data | Source |
|------|--------|
| Flood risk scores | ALOS PALSAR 12.5 m DEM stream network + historical flood events |
...
4. **Tap any zone** for a full area report (flood score, price range, commute, metro, nearby facilities)
...
- **ALOS PALSAR DEM** — flood stream analysis
